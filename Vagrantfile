...
Vagrant.configure("2") do |config|
  ...
  config.vm.box_url = "https://opscode-vm-bento.s3.amazonaws.com/vagrant/vmware/opscode_ubuntu-14.04-i386_chef-provisionerless.box"
  ...
  config.vm.hostname = "example-development"
  ...
  #   chef.validation_client_name = "example-validator"
  #   chef.validation_key_path = ".chef/example-validator.pem"
  # end
end
